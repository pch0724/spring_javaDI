...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("lazy-init = true이므로 호출해야만 생성자 반환됨");
		...
		System.out.println("scope = prototype을 이용하여 다른 주소 값 반환");
		...
		/*
		  System.out.println("메서드 이름으로 객체 받기"); TestBean1 java500 =
		  ctx2.getBean("java500", TestBean1.class); System.out.println("java500 : " +
		  java500);
		 */
		System.out.println("@Bean(name = '')으로 객체 받기");
		TestBean1 java600 = ctx2.getBean("java600", TestBean1.class);		
		System.out.println("java600 : " + java600);
		System.out.println();
		
		
		System.out.println("@lazy => 호출 시 생성자 반환");
		...
		System.out.println("@scope('prototype')을 이용하여 다른 주소 값 반환");
		...
		System.out.println("@Primary를 이용하여 클래스 중복시 사용하여 정상값 가져오기");
